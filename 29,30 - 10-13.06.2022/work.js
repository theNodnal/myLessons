...
3 раза отвечать на вопрос "Ваш любимый жанр под номером 
${номер по порядку}". Каждый ответ записывается в массив данных
genres
...
function showMyDB(hiddn) {
    if (!hiddn) {
        console.log(personalMovieD);
    }
}
showMyDB(personalMovieD.privat);
